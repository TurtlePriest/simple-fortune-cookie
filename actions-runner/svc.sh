...
SVC_NAME="actions.runner.TurtlePriest-simple-fortune-cookie.devopsacademy-instance.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (TurtlePriest-simple-fortune-cookie.devopsacademy-instance81)"
